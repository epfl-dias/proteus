...
//
//		AllocaInst *mem_accumulating = resetAccumulator(outputExpr, acc);
//
//#ifdef DEBUG
...
//void Nest::generateSum(expressions::Expression* outputExpr, RawContext* const context, const OperatorState& state, AllocaInst *mem_accumulating) const	{
//	IRBuilder<>* Builder = context->getBuilder();
//	LLVMContext& llvmContext = context->getLLVMContext();
//	Function *TheFunction = Builder->GetInsertBlock()->getParent();
//
