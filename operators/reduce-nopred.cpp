...
ReduceNoPred::ReduceNoPred(Monoid acc, expressions::Expression* outputExpr,
		...
		UnaryRawOperator(child), acc(acc), outputExpr(outputExpr), context(
				context) {
	...
	case SUM: {
		...
		default: {
			string error_msg = string(
					"[ReduceNoPred: ] Sum/Multiply/Max operate on numerics");
			LOG(ERROR)<< error_msg;
	...
	case OR:	{
		...
		default: {
			string error_msg = string("[ReduceNoPred: ] Or/And operate on booleans");
			LOG(ERROR)<< error_msg;
			throw runtime_error(error_msg);
		}
...
void ReduceNoPred::generate(RawContext* const context, const OperatorState& childState) const
{
	IRBuilder<>* Builder = context->getBuilder();
	LLVMContext& llvmContext = context->getLLVMContext();
...
void ReduceNoPred::generateSum(RawContext* const context, const OperatorState& childState) const	{
	IRBuilder<>* Builder = context->getBuilder();
	LLVMContext& llvmContext = context->getLLVMContext();
	Function *TheFunction = Builder->GetInsertBlock()->getParent();
...
void ReduceNoPred::generateMul(RawContext* const context, const OperatorState& childState) const	{
	IRBuilder<>* Builder = context->getBuilder();
	LLVMContext& llvmContext = context->getLLVMContext();
	Function *TheFunction = Builder->GetInsertBlock()->getParent();
...
void ReduceNoPred::generateMax(RawContext* const context, const OperatorState& childState) const	{
	IRBuilder<>* Builder = context->getBuilder();
	LLVMContext& llvmContext = context->getLLVMContext();
	Function *TheFunction = Builder->GetInsertBlock()->getParent();
...
void ReduceNoPred::generateOr(RawContext* const context, const OperatorState& childState) const {
	IRBuilder<>* Builder = context->getBuilder();
	LLVMContext& llvmContext = context->getLLVMContext();
	Function *TheFunction = Builder->GetInsertBlock()->getParent();
	...
	default: {
		string error_msg = string(
				"[ReduceNoPred: ] Or accumulator operates on numerics");
		LOG(ERROR)<< error_msg;
		throw runtime_error(error_msg);
	}
	}
...
void ReduceNoPred::generateAnd(RawContext* const context, const OperatorState& childState) const {
	IRBuilder<>* Builder = context->getBuilder();
	LLVMContext& llvmContext = context->getLLVMContext();
	Function *TheFunction = Builder->GetInsertBlock()->getParent();
...
void ReduceNoPred::generateUnion(RawContext* const context, const OperatorState& childState) const	{
	IRBuilder<>* Builder = context->getBuilder();
	LLVMContext& llvmContext = context->getLLVMContext();
	Function *TheFunction = Builder->GetInsertBlock()->getParent();
	...
	ExpressionFlusherVisitor flusher = ExpressionFlusherVisitor(context,
			childState, outFilename);
...
void ReduceNoPred::generateAppend(RawContext* const context, const OperatorState& childState) const	{
