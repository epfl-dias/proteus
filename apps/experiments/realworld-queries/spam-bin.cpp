...
// where id > 70000000  and id < 80000000 and (p_event > 0.7 OR value > 0.5) and
// cluster = 400;
void symantecBin4v1(map<string, dataset> datasetCatalog) {
  ...
  accs.push_back(MAX);
  expressions::Expression *outputExpr1 =
      new expressions::RecordProjection(dim->getOriginalType(), argProj, *dim);
  outputExprs.push_back(outputExpr1);
...
void symantecBin6v2(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predExpr1 = new expressions::IntConstant(idLow);
  //    expressions::Expression* predExpr2 = new
  //    expressions::IntConstant(idHigh);
  expressions::Expression *predExpr3 =
      new expressions::IntConstant(clusterHigh);
  expressions::Expression *predicate1 =
      new expressions::GtExpression(selID, predExpr1);
...
void symantecBin7v1(map<string, dataset> datasetCatalog) {
  ...
  //    expressions::Expression* selDim      =
  //                    new
  //                    expressions::RecordProjection(dim->getOriginalType(),arg,*dim);
  expressions::Expression *selCluster = new expressions::RecordProjection(
      cluster->getOriginalType(), arg, *cluster);

  //    expressions::Expression* predExpr1 = new
  //    expressions::IntConstant(idLow); expressions::Expression* predExpr2 =
  //    new expressions::IntConstant(idHigh); expressions::Expression* predExpr3
  //    = new expressions::IntConstant(
  //            dimHigh);
  expressions::Expression *predExpr4 = new expressions::IntConstant(clusterLow);
  expressions::Expression *predExpr5 =
      new expressions::IntConstant(clusterHigh);
...
void symantecBin7v2(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predExpr1 = new expressions::IntConstant(idLow);
  //    expressions::Expression* predExpr2 = new
  //    expressions::IntConstant(idHigh); expressions::Expression* predExpr3 =
  //    new expressions::IntConstant(
  //            dimHigh);
  expressions::Expression *predExpr4 = new expressions::IntConstant(clusterLow);
  expressions::Expression *predExpr5 =
...
void symantecBin8v1(map<string, dataset> datasetCatalog) {
  ...
  //                        new
  //                        expressions::RecordProjection(p_event->getOriginalType(),arg,*p_event);
  //    expressions::Expression* selValue      =
  //                        new
  //                        expressions::RecordProjection(value->getOriginalType(),arg,*value);
  expressions::Expression *selCluster = new expressions::RecordProjection(
      cluster->getOriginalType(), arg, *cluster);
