...
int main() {
  cout << "Execution (Caching + Materializers ON)" << endl;
  map<string, dataset> datasetCatalog;
  symantecCSVSchema(datasetCatalog);

  cout << "Warmup: SYMANTEC CSV 1 (+Caching)" << endl;
...
void symantecCSV5(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predicate3 =
      new expressions::LtExpression(selSize, predExpr4);
  ...
  // bot = 'FESTI'
  expressions::Expression *predicateStr_ =
      new expressions::EqExpression(selBot, predExpr3);
  ...
  expressions::Expression *predicateStr =
      new expressions::AndExpression(predicateStr_, predicateOr);
...
void symantecCSV7(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predicate =
      new expressions::AndExpression(predicateAnd_, predicateAnd2);
