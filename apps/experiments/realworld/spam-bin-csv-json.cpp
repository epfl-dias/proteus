...
void symantecBinCSVJSON2Debug1(map<string, dataset> datasetCatalog) {
  ...
  Context &ctx = *prepareContext("symantec-bin-csv-json-2-dbg");
  ...
  expressions::Expression *predExpr =
      new expressions::FloatConstant(p_eventHigh);
  ...
  //              0, argProjectionsCSV);
  //      expressions::Expression* selClassa = new
  ...
  //  expressions::Expression* rightArg = new
  //  expressions::InputArgument(&recCSV,
  ...
  //  RadixJoin *joinBinCSV = new RadixJoin(*joinPred, selBin, selCSV, &ctx,
  //  joinLabel,
  //          *matLeft, *matRight);
  ...
  //      expressions::Expression* arg = new
  //      expressions::InputArgument(&recJSON,
  ...
  //  expressions::Expression* leftArg2 = new
  //  expressions::InputArgument(&recBin, 0,
  //          argProjectionsLeft2);
  ...
  //  expressions::Expression* rightArg2 = new
  //  expressions::InputArgument(&recJSON,
  ...
  //  expressions::Expression* exprLeftOID2a = new
  //  expressions::RecordProjection(
  //          pgBin->getOIDType(), leftArg2, *projTupleL2a);
  //  expressions::Expression* exprLeftOID2b = new
  //  expressions::RecordProjection(
  ...
  opt::Reduce *reduce =
      new opt::Reduce(accs, outputExprs, predRed, selBin, &ctx);
...
void symantecBinCSVJSON2Debug2(map<string, dataset> datasetCatalog) {
  ...
  Context &ctx = *prepareContext("symantec-bin-csv-json-2-dbg2");
  Catalog &rawCatalog = Catalog::getInstance();
  ...
  expressions::Expression *predicateCSV;
  {
    ...
    expressions::Expression *predExpr = new expressions::IntConstant(classaLow);
  ...
  opt::Reduce *reduce =
      new opt::Reduce(accs, outputExprs, predRed, selCSV, &ctx);
...
void symantecBinCSVJSON2Debug3(map<string, dataset> datasetCatalog) {
  ...
  Context &ctx = *prepareContext("symantec-bin-csv-json-2-dbg3");
  Catalog &rawCatalog = Catalog::getInstance();
  ...
  //  expressions::Expression* predExprB = new
  //  expressions::IntConstant(1926807); expressions::Expression* predExprC =
  //  new expressions::IntConstant(1930155); expressions::Expression* predExprD
  //  = new expressions::IntConstant(1930229); expressions::Expression*
  //  predExprE = new expressions::IntConstant(1930235);
  //  expressions::Expression* predExprF = new
  //  expressions::IntConstant(1979928); expressions::Expression* predExprG =
  //  new expressions::IntConstant(2346485); expressions::Expression* predExprH
  //  = new expressions::IntConstant(2346648); expressions::Expression*
  //  predExprI = new expressions::IntConstant(2346705);
  //  expressions::Expression* predExprJ = new
  //  expressions::IntConstant(3977494); expressions::Expression* predicateA =
  //  new expressions::EqExpression(selID, predExprA); expressions::Expression*
  //  predicateB = new expressions::EqExpression(selID, predExprB);
  //  expressions::Expression* predicateC = new expressions::EqExpression(selID,
  //  predExprC); expressions::Expression* predicateD = new
  //  expressions::EqExpression(selID, predExprD);
  //
  //  expressions::Expression* predicateOr1 = new
  //  expressions::OrExpression(predicateA,predicateB); expressions::Expression*
  //  predicateOr2 = new expressions::OrExpression(predicateC,predicateD);
  ...
  opt::Reduce *reduce =
      new opt::Reduce(accs, outputExprs, predRed, selJSON, &ctx);
...
void symantecBinCSVJSON0(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *selID =
      new expressions::RecordProjection(idBin->getOriginalType(), arg, *idBin);
...
void symantecBinCSVJSON1(map<string, dataset> datasetCatalog) {
  ...
  argProjectionsLeft2.push_back(*idBin);
  argProjectionsLeft2.push_back(*dim);
  expressions::Expression *leftArg2 =
      new expressions::InputArgument(&recBin, 0, argProjectionsLeft2);
  expressions::Expression *leftPred2 = new expressions::RecordProjection(
      idBin->getOriginalType(), leftArg2, *idBin);
  ...
  list<RecordAttribute> argProjectionsRight2;
  argProjectionsRight2.push_back(*idJSON);
  expressions::Expression *rightArg2 =
      new expressions::InputArgument(&recJSON, 1, argProjectionsRight2);
  expressions::Expression *rightPred2 = new expressions::RecordProjection(
      idJSON->getOriginalType(), rightArg2, *idJSON);

  /* join pred. */
  expressions::BinaryExpression *joinPred2 =
      new expressions::EqExpression(leftPred2, rightPred2);

  /* explicit mention to left OIDs */
  RecordAttribute *projTupleL2a =
      new RecordAttribute(fnamePrefixBin, activeLoop, pgBin->getOIDType());
  RecordAttribute *projTupleL2b =
      new RecordAttribute(fnameCSV, activeLoop, pgCSV->getOIDType());
  vector<RecordAttribute *> OIDLeft2;
  OIDLeft2.push_back(projTupleL2a);
  OIDLeft2.push_back(projTupleL2b);
  ...
  argProjections.push_back(*dim);
  expressions::Expression *exprDim =
      new expressions::RecordProjection(dim->getOriginalType(), leftArg2, *dim);
  /* Output: */
  vector<Monoid> accs;
  vector<expression_t> outputExprs;
  ...
  opt::Reduce *reduce =
      new opt::Reduce(accs, outputExprs, predRed, joinJSON, &ctx);
...
void symantecBinCSVJSON2(map<string, dataset> datasetCatalog) {
  ...
  Context &ctx = *prepareContext("symantec-bin-csv-json-2");
  Catalog &rawCatalog = Catalog::getInstance();
...
void symantecBinCSVJSON3(map<string, dataset> datasetCatalog) {
  ...
  Context &ctx = *prepareContext("symantec-bin-csv-json-3");
  Catalog &rawCatalog = Catalog::getInstance();
...
void symantecBinCSVJSON5(map<string, dataset> datasetCatalog) {
  ...
  /*
   * SELECT CSV
   * (bot = 'Bobax' OR bot = 'UNCLASSIFIED' or bot = 'Unclassified') and sc.id >
   * 7000000  and sc.id < 10000000;
   */
  Select *selCSV;
  expressions::Expression *predicateCSV;
  {
    ...
    expressions::Expression *predExprStr1 =
        new expressions::StringConstant(botName1);
    expressions::Expression *predExprStr2 =
        new expressions::StringConstant(botName2);
    expressions::Expression *predExprStr3 =
        new expressions::StringConstant(botName3);
    expressions::Expression *predicateStr1 =
        new expressions::EqExpression(selBot, predExprStr1);
    expressions::Expression *predicateStr2 =
        new expressions::EqExpression(selBot, predExprStr2);
    expressions::Expression *predicateStr3 =
        new expressions::EqExpression(selBot, predExprStr3);
    expressions::Expression *predicateOr1 =
        new expressions::OrExpression(predicateStr1, predicateStr2);

    predicateCSV = new expressions::OrExpression(predicateOr1, predicateStr3);
  ...
  /*
   * SELECT JSON
   * (data->'day'->>'year')::int > 2010 and (data->>'id')::int > 7000000 and
   * (data->>'id')::int < 10000000
   */
  Select *selJSON;
  expressions::Expression *predicateJSON;
  {
    ...
    RecordAttribute *year =
        new RecordAttribute(1, fnameJSON, "year", &yearType);
    ...
    expressions::Expression *predExprYear =
        new expressions::IntConstant(yearLow);
    expressions::Expression *predicateYear =
        new expressions::GtExpression(selYear, predExprYear);
...
void symantecBinCSVJSON6(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predExpr3 = new expressions::IntConstant(clusterLow);
  expressions::Expression *predicate3 =
      new expressions::GtExpression(selCluster, predExpr3);
  ...
  /*
   * SELECT CSV
   * (classA < 75 OR (bot = 'Bobax' OR bot = 'UNCLASSIFIED' or bot =
   * 'Unclassified')) and sc.id > 5000000 and sc.id < 10000000
   */
  Select *selCSV;
  expressions::Expression *predicateCSV;
  {
    ...
    expressions::Expression *predicateOr1 =
        new expressions::OrExpression(predicateStr1, predicateStr2);
    expressions::Expression *predicateOr2 =
        new expressions::OrExpression(predicateOr1, predicateStr3);

    predicateCSV = new expressions::OrExpression(predicateOr2, predicate3);
    selCSV = new Select(predicateCSV, selNum);
    selNum->setParent(selCSV);
  }
  ...
  /*
   * SELECT JSON
   * (data->'day'->>'year')::int > 2010 and (data->>'id')::int > 5000000 and
   * (data->>'id')::int < 10000000
   */
  Select *selJSON;
  expressions::Expression *predicateJSON;
