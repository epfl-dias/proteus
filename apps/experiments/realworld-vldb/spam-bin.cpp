...
void symantecBin1(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predExpr1 = new expressions::IntConstant(dim1);
  expressions::Expression *predExpr2 = new expressions::IntConstant(dim2);
  expressions::Expression *predicate1 =
      new expressions::EqExpression(selDim, predExpr1);
  expressions::Expression *predicate2 =
      new expressions::EqExpression(selDim, predExpr2);
  expressions::Expression *predicate =
      new expressions::OrExpression(predicate1, predicate2);
...
void symantecBin4(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predicateAnd2 =
      new expressions::AndExpression(predicate2, predicateOr);
  expressions::Expression *predicate =
