...
PreparedStatement Query::prepare22(bool memmv, size_t bloomSize) {
  auto rel23990 =
      getBuilder<Tplugin>()
          .scan(
  ...
  auto rel23999 =
      getBuilder<Tplugin>()
          ...
          .unpack()  // (trait=[Pelago.[].unpckd.NVPTX.homBrdcst.hetSingle])
          .filter([&](const auto &arg) -> expression_t {
            return (ge(arg["p_brand1"], "MFGR#2221") &
...
PreparedStatement Query::prepare22_b(bool memmv, size_t bloomSize) {
  auto rel =
      getBuilder<Tplugin>()
