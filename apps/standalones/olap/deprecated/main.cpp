...
void expressionMap() {
  ...
  /* 2nd Input Arg */
  projections.push_back(projTuple);
  expressions::Expression *inputArg2 =
      new expressions::InputArgument(&inner, 0, projections);
...
void expressionMapVertical() {
  ...
  expressions::RecordProjection *proj1 =
      new expressions::RecordProjection(&stringType, inputArg, emp1);
  expressions::RecordProjection *proj2 =
      new expressions::RecordProjection(&intType, inputArg, emp2);
  expressions::RecordProjection *proj3 =
      new expressions::RecordProjection(&intType, inputArg, emp3);
  mapTest[proj1] = 112;
  mapTest[proj2] = 113;
  mapTest[proj3] = 114;
...
void nest() {
  ...
  Nest nestOp =
      Nest(SUM, nestToAggr, predicate, f, f, &unnestOp, nestLabel, *mat);
  ...
  RecordAttribute toOutput = RecordAttribute(1, aggrLabel, aggrField, &intType);
...
void unnestJsmnDeeper() {
  ...
  RecordAttribute childrenAges =
      RecordAttribute(1, fname, ages, &childrenAgesType);
  ...
  expressions::Expression *inputArg =
      new expressions::InputArgument(&inner, 0, projections);
  expressions::RecordProjection *proj =
      new expressions::RecordProjection(&children, inputArg, emp3);
  expressions::RecordProjection *projDeeper =
      new expressions::RecordProjection(&childrenAgesType, proj, childrenAges);
  string nestedName = "c";
  ...
  RecordAttribute toPrint = RecordAttribute(
      2, fname + "." + empChildren + "." + ages, activeLoop, &intType);
...
void unnestJsmnFiltering() {
  ...
  expressions::Expression *inputArg =
      new expressions::InputArgument(&inner, 0, projections);
  expressions::RecordProjection *proj =
      new expressions::RecordProjection(&stringType, inputArg, emp3);
  string nestedName = "c";
  Path path = Path(nestedName, proj);
...
void selectionCSV() {
  ...
  expressions::Expression *lhsArg =
      new expressions::InputArgument(intType, 0, projections);
  expressions::Expression *lhs =
      new expressions::RecordProjection(intType, lhsArg, *sid);
  ...
  expressions::RecordProjection *proj =
      new expressions::RecordProjection(floatType, lhsArg, *age);
...
void joinQueryRelational() {
  ...
  PrimitiveType *intType = new IntType();
  PrimitiveType *int64Type = new Int64Type();
  RecordAttribute *attr1 =
      new RecordAttribute(1, filename, string("att1"), intType);
  RecordAttribute *attr2 =
      new RecordAttribute(2, filename, string("att2"), intType);
  RecordAttribute *attr3 =
      new RecordAttribute(3, filename, string("att3"), intType);
  list<RecordAttribute *> attrList;
  ...
  expressions::Expression *lhsArg =
      new expressions::InputArgument(intType, 0, projectionsL);
  expressions::Expression *lhs =
      new expressions::RecordProjection(intType, lhsArg, *attr1);
  ...
  RecordAttribute *attr1_f2 =
      new RecordAttribute(1, filename2, string("att1"), intType);
  RecordAttribute *attr2_f2 =
      new RecordAttribute(2, filename2, string("att2"), intType);
  RecordAttribute *attr3_f2 =
      new RecordAttribute(3, filename2, string("att3"), intType);
  ...
  RecordAttribute projTupleR =
      RecordAttribute(filename2, activeLoop, int64Type);
  ...
  expressions::Expression *left =
      new expressions::RecordProjection(intType, leftArg, *attr2);
  expressions::Expression *rightArg =
      new expressions::InputArgument(intType, 1, projectionsR);
  ...
  expressions::RecordProjection *proj =
      new expressions::RecordProjection(new IntType(), leftArg, *attr1);
...
void joinQueryRelationalRadix() {
  ...
  RecordAttribute projTupleR =
      RecordAttribute(filename2, activeLoop, pg2->getOIDType());
  list<RecordAttribute> projectionsR = list<RecordAttribute>();
  projectionsR.push_back(projTupleR);
  projectionsR.push_back(*attr1_f2);
  projectionsR.push_back(*attr2_f2);
  ...
  expressions::Expression *exprLeftOID =
      new expressions::RecordProjection(pg->getOIDType(), leftArg, projTupleL);
  expressions::Expression *exprLeftMat1 =
      new expressions::RecordProjection(intType, leftArg, *attr1);
  expressions::Expression *exprLeftMat2 =
      new expressions::RecordProjection(intType, leftArg, *attr2);
  ...
  expressions::Expression *exprRightMat1 =
      new expressions::RecordProjection(intType, rightArg, *attr1_f2);
  expressions::Expression *exprRightMat2 =
      new expressions::RecordProjection(intType, rightArg, *attr2_f2);
  ...
  outputModes.insert(outputModes.begin(), EAGER);
  outputModes.insert(outputModes.begin(), EAGER);
  Materializer *matRight = new Materializer(whichFields2, whichExpressionsRight,
                                            whichOIDRight, outputModes);

  char joinLabel[] = "radixJoin1";
  RadixJoin join =
      RadixJoin(*joinPred, &scan, &scan2, &ctx, joinLabel, *matLeft, *matRight);
  scan.setParent(&join);
  scan2.setParent(&join);
...
void joinQueryRelationalRadixCache() {
  ...
  //    CSVPlugin* pg = new CSVPlugin(&ctx, filename, rec1, whichFields);
  pm::CSVPlugin *pg =
      new pm::CSVPlugin(&ctx, filename, rec1, whichFields, 3, 2);
  catalog.registerPlugin(filename, pg);
  Scan scan = Scan(&ctx, *pg);
  ...
  string filename2 = string("inputs/input2.csv");
  RecordAttribute *attr1_f2 =
      new RecordAttribute(1, filename2, string("att1_r"), intType);
  RecordAttribute *attr2_f2 =
      new RecordAttribute(2, filename2, string("att2_r"), intType);
  RecordAttribute *attr3_f2 =
      new RecordAttribute(3, filename2, string("att3_r"), intType);
  ...
  //    CSVPlugin* pg2 = new CSVPlugin(&ctx, filename2, rec2, whichFields2);
  pm::CSVPlugin *pg2 =
      new pm::CSVPlugin(&ctx, filename2, rec2, whichFields2, 2, 2);
  catalog.registerPlugin(filename2, pg2);
  Scan scan2 = Scan(&ctx, *pg2);
  LOG(INFO) << "Right:" << &scan2;
...
void reduceListInt() {
  ...
  expressions::Expression *outputExpr =
      new expressions::RecordProjection(&intType, arg, attr);
...
void reduceListIntCSV() {
  ...
  PrimitiveType *floatType = new FloatType();
  PrimitiveType *stringType = new StringType();
  RecordAttribute *sid = new RecordAttribute(1, fname, string("sid"), intType);
  RecordAttribute *sname =
      new RecordAttribute(2, fname, string("sname"), stringType);
  RecordAttribute *rating =
      new RecordAttribute(3, fname, string("rating"), intType);
  RecordAttribute *age =
      new RecordAttribute(4, fname, string("age"), floatType);
...
void reduceListRecordConstruction() {
  ...
  expressions::Expression *newAttrExpr1 =
      new expressions::RecordProjection(&nested, arg, attr3);
  expressions::Expression *newAttrExpr2 =
      new expressions::RecordProjection(&intType, arg, attr2);
  expressions::AttributeConstruction attrExpr1 =
      expressions::AttributeConstruction("scalar", newAttrExpr1);
  expressions::AttributeConstruction attrExpr2 =
      expressions::AttributeConstruction("object", newAttrExpr2);
  ...
  expressions::RecordConstruction newRec =
      expressions::RecordConstruction(&newRecType, newAtts);
...
void scanCSVBoolean() {
  ...
  PrimitiveType *stringType = new StringType();
  RecordAttribute *category =
      new RecordAttribute(1, filename, string("category"), stringType);
  RecordAttribute *amount =
      new RecordAttribute(2, filename, string("amount"), intType);
  RecordAttribute *isPaid =
      new RecordAttribute(3, filename, string("isPaid"), boolType);
  ...
  expressions::Expression *arg =
      new expressions::InputArgument(&rec1, 0, projections);
  expressions::RecordProjection *proj =
      new expressions::RecordProjection(boolType, arg, *isPaid);
...
void reduceBoolean() {
  ...
  expressions::Expression *lhs =
      new expressions::RecordProjection(intType, arg, *amount);
...
void cidrBin() {
  ...
  RecordAttribute *field2 =
      new RecordAttribute(2, filenameBin, "field2", intType);
  RecordAttribute *field4 =
      new RecordAttribute(4, filenameBin, "field4", intType);
  whichFieldsBin.push_back(field2);
  whichFieldsBin.push_back(field4);

  BinaryRowPlugin *pgBin =
      new BinaryRowPlugin(&ctx, filenameBin, recBin, whichFieldsBin);
  ...
  RecordAttribute projTuple =
      RecordAttribute(filenameBin, activeLoop, pgBin->getOIDType());
  list<RecordAttribute> projections = list<RecordAttribute>();
  projections.push_back(*field2);
  projections.push_back(*field4);
  expressions::Expression *arg =
      new expressions::InputArgument(&recBin, 0, projections);
  expressions::RecordProjection *proj =
      new expressions::RecordProjection(intType, arg, *field4);
...
void cidrBinStrConstant() {
  ...
  expressions::Expression *selPredicate =
      new expressions::EqExpression(arg1str, arg2str);
...
void cidrBinStr() {
  ...
  while (fieldCount <= 5) {
    ...
    if (fieldCount != 3) {
      ...
      attr =
          new RecordAttribute(fieldCount++, filenameBin, attrname, stringType);
    }
    attrListBin.push_back(attr);
  }
  printf("Schema Ingested\n");
  ...
  RecordType recBin = RecordType(attrListBin);
  vector<RecordAttribute *> whichFieldsBin;
  RecordAttribute *field3 =
      new RecordAttribute(3, filenameBin, "field3", stringType);
  RecordAttribute *field4 =
      new RecordAttribute(4, filenameBin, "field4", intType);
  ...
  expressions::Expression *lhsArg =
      new expressions::InputArgument(&recBin, 0, projections);
  expressions::RecordProjection *lhsProj =
      new expressions::RecordProjection(stringType, lhsArg, *field3);

  string constStr = string("ALZHM");
  expressions::Expression *arg2str = new expressions::StringConstant(constStr);
  expressions::Expression *selPredicate =
      new expressions::EqExpression(lhsProj, arg2str);
  Select selStr = Select(selPredicate, &scanBin);
  scanBin.setParent(&selStr);
...
void cidrQuery3() {
  ...
  RecordAttribute *rid =
      new RecordAttribute(1, filenameClinical, "RID", intType);
  RecordAttribute *age =
      new RecordAttribute(1, filenameClinical, "Age", intType);
  whichFieldsClinical.push_back(rid);
  whichFieldsClinical.push_back(age);

  CSVPlugin *pgClinical =
      new CSVPlugin(&ctx, filenameClinical, recClinical, whichFieldsClinical);
  catalog.registerPlugin(filenameClinical, pgClinical);
  Scan scanClinical = Scan(&ctx, *pgClinical);

  // SELECT
  RecordAttribute projTupleClinical =
      RecordAttribute(filenameClinical, activeLoop, pgClinical->getOIDType());
  ...
  expressions::Expression *argClinical =
      new expressions::InputArgument(&recClinical, 0, projectionsClinical);
  ...
  expressions::Expression *selPredicate =
      new expressions::GtExpression(clinicalAge, rhs);
  ...
  RecordAttribute *iid =
      new RecordAttribute(2, filenameGenetic, "IID", intType);
  whichFieldsGenetic.push_back(iid);

  CSVPlugin *pgGenetic =
      new CSVPlugin(&ctx, filenameGenetic, recGenetic, whichFieldsGenetic);
  ...
  RecordAttribute projTupleGenetic =
      RecordAttribute(filenameGenetic, activeLoop, pgGenetic->getOIDType());
  ...
  expressions::Expression *argGenetic =
      new expressions::InputArgument(&recGenetic, 0, projectionsGenetic);
  expressions::RecordProjection *argGeneticProj =
      new expressions::RecordProjection(intType, argGenetic, *iid);

  expressions::BinaryExpression *joinPred =
      new expressions::EqExpression(argClinicalProj, argGeneticProj);
  vector<materialization_mode> outputModes;
  // active loop too
  outputModes.insert(outputModes.begin(), EAGER);
  outputModes.insert(outputModes.begin(), EAGER);
  ...
  // expressions::RecordProjection* outputExpr = new
  // expressions::RecordProjection(intType,argClinical,*rid);

  expressions::Expression *val_true = new expressions::BoolConstant(1);
  expressions::Expression *predicate =
      new expressions::EqExpression(val_true, val_true);
...
void cidrQuery3Radix() {
  ...
  Materializer *matLeft = new Materializer(
      whichFieldsClinical, whichExpressionsLeft, whichOIDsGenetic, outputModes);
  ...
  Materializer *matRight = new Materializer(
      whichFieldsGenetic, whichExpressionsRight, whichOIDsGenetic, outputModes);

  char joinLabel[] = "joinPatients";
  RadixJoin join = RadixJoin(*joinPred, &selClinical, &scanGenetic, &ctx,
...
void cidrQuery3RadixMax() {
  ...
  Materializer *matRight =
      new Materializer(whichFieldsGenetic, whichExpressionsRight,
                       whichOIDsGenetic, outputModesGenetic);
...
void cidrQueryWarm(int ageParam, int volParam) {
  ...
  RecordAttribute *rid =
      new RecordAttribute(1, filenameClinical, "rid", intType);
  RecordAttribute *age =
      new RecordAttribute(2, filenameClinical, "age", intType);
  RecordAttribute *city =
      new RecordAttribute(3, filenameClinical, "city", stringType);
  list<RecordAttribute *> attrListClinical;
  ...
  BinaryRowPlugin *pgClinical = new BinaryRowPlugin(
      &ctx, filenameClinical, recClinical, whichFieldsClinical);
  ...
  expressions::Expression *selPredicate1 =
      new expressions::GtExpression(clinicalAge, rhsAge);
  ...
  expressions::Expression *rhsCity = new expressions::StringConstant(cityName);
  expressions::Expression *selPredicate2 =
      new expressions::EqExpression(clinicalCity, rhsCity);

  expressions::Expression *selPredicate =
      new expressions::AndExpression(selPredicate1, selPredicate2);
   ...
   * SCAN (Regions)
   */
  RecordAttribute *iidRegions =
      new RecordAttribute(1, filenameRegions, "iid", intType);
  RecordAttribute *vol =
      new RecordAttribute(2, filenameRegions, "vol", intType);
  ...
  BinaryRowPlugin *pgRegions = new BinaryRowPlugin(
      &ctx, filenameRegions, recRegions, whichFieldsRegions);
   ...
   * SELECT
   */
  RecordAttribute projTupleRegions =
      RecordAttribute(filenameRegions, activeLoop, int64Type);
  ...
  expressions::Expression *argRegions =
      new expressions::InputArgument(&recRegions, 0, projectionsRegions);
  ...
  expressions::BinaryExpression *joinPredClinical =
      new expressions::EqExpression(argClinicalId, argRegionsId);
  ...
  Join joinClinicalRegions =
      Join(joinPredClinical, &selClinical, &scanRegions, joinLabel, *mat);
   ...
   */
  RecordAttribute *fid =
      new RecordAttribute(1, filenameGenetic, "fid", stringType);
  RecordAttribute *iid =
      new RecordAttribute(2, filenameGenetic, "iid", intType);
  list<RecordAttribute *> attrListGenetic;
  ...
  BinaryRowPlugin *pgGenetic = new BinaryRowPlugin(
      &ctx, filenameGenetic, recGenetic, whichFieldsGenetic);
   ...
   */
  RecordAttribute projTupleGenetic =
      RecordAttribute(filenameGenetic, activeLoop, int64Type);
  list<RecordAttribute> projectionsGenetic = list<RecordAttribute>();
  projectionsGenetic.push_back(projTupleGenetic);
  ...
  expressions::BinaryExpression *joinPredGenetic =
      new expressions::EqExpression(argRegionsId, argGeneticId);
  vector<materialization_mode> outputModes2;
...
void ifThenElse() {
  ...
  expressions::Expression *arg =
      new expressions::InputArgument(&rec1, 0, projections);
  expressions::Expression *ifLhs =
      new expressions::RecordProjection(boolType, arg, *amount);
  ...
  expressions::Expression *ifElse =
      new expressions::IfThenElse(ifCond, trueCons, falseCons);

  expressions::Expression *predicate =
      new expressions::EqExpression(trueCons, trueCons);
...
void columnarQueryCount() {
  ...
  BinaryColPlugin *pgRegions =
      new BinaryColPlugin(&ctx, filenamePrefix, recRegions, whichFieldsRegions);
...
void columnarQuerySum() {
  ...
  list<RecordAttribute> projections = list<RecordAttribute>();
  RecordAttribute projTupleRegions =
      RecordAttribute(filenamePrefix, activeLoop, int64Type);
  projections.push_back(projTupleRegions);
  projections.push_back(*pid);
  projections.push_back(*rid);
  expressions::Expression *arg =
      new expressions::InputArgument(&recRegions, 0, projections);
  expressions::Expression *projRid =
      new expressions::RecordProjection(intType, arg, *pid);
...
void columnarMax1() {
  ...
  for (int i = 1; i <= 30; i++) {
    ...
    RecordAttribute *field_i = new RecordAttribute(
        fieldCount, filenamePrefix, sstream.str().c_str(), intType);
  ...
  expressions::Expression *arg =
      new expressions::InputArgument(&recRegions, 0, projections);
  expressions::Expression *projRid =
      new expressions::RecordProjection(intType, arg, *toProject);
...
void columnarMax2() {
  ...
  BinaryColPlugin *pgColumnar =
      new BinaryColPlugin(&ctx, filenamePrefix, recInts, whichFields);
  ...
  expressions::Expression *lhsArg =
      new expressions::InputArgument(&recInts, 0, projections);
  expressions::Expression *lhs =
      new expressions::RecordProjection(intType, lhsArg, *selectProj);
  expressions::Expression *rhs = new expressions::IntConstant(100000000);
  expressions::Expression *predicate = new expressions::LtExpression(lhs, rhs);
  ...
  expressions::Expression *proj =
      new expressions::RecordProjection(intType, lhsArg, *toProject);
...
void columnarMax3() {
  ...
  expressions::Expression *lhsArg =
      new expressions::InputArgument(&recInts, 0, projections);
  expressions::Expression *lhs1 =
      new expressions::RecordProjection(intType, lhsArg, *selectProj1);
  expressions::Expression *rhs1 = new expressions::IntConstant(100000000);
  expressions::Expression *predicate1 =
      new expressions::LtExpression(lhs1, rhs1);

  expressions::Expression *lhs2 =
      new expressions::RecordProjection(intType, lhsArg, *selectProj2);
  expressions::Expression *rhs2a = new expressions::IntConstant(200000000);
  expressions::Expression *predicate2a =
      new expressions::LtExpression(lhs2, rhs2a);

  expressions::Expression *rhs2b = new expressions::IntConstant(100000000);
  expressions::Expression *predicate2b =
      new expressions::GtExpression(lhs2, rhs2b);

  expressions::Expression *predicate2 =
      new expressions::AndExpression(predicate2a, predicate2b);
  expressions::Expression *predicate =
...
void columnarJoin1() {
  ...
  /* Segfault */
  string filenamePrefixLeft = string(
      "/cloud_store/manosk/data/vida-engine/"
      "synthetic/100m-30cols-fixed-shuffled");
  string filenamePrefixRight = string(
      "/cloud_store/manosk/data/vida-engine/synthetic/100m-30cols-fixed");

  /* Works */
  //    string filenamePrefixLeft =
  //    string("/cloud_store/manosk/data/vida-engine/synthetic/10k-30cols-fixed-shuffled");
  //    string filenamePrefixRight =
  //    string("/cloud_store/manosk/data/vida-engine/synthetic/10k-30cols-fixed");

  /* Works */
  //    string filenamePrefixLeft =
  //    string("/cloud_store/manosk/data/vida-engine/synthetic/100-30cols-fixed");
  //    string filenamePrefixRight =
  //    string("/cloud_store/manosk/data/vida-engine/synthetic/500-30cols-fixed");
  ...
  for (int i = 1; i <= 30; i++) {
    ...
    sstream << "field" << fieldCount;
    RecordAttribute *field_i = new RecordAttribute(
        fieldCount, filenamePrefixLeft, sstream.str().c_str(), intType);
  ...
  BinaryColPlugin *pgColumnarLeft = new BinaryColPlugin(
      &ctx, filenamePrefixLeft, recIntsLeft, whichFieldsLeft);
  ...
  expressions::Expression *lhsArg =
      new expressions::InputArgument(&recIntsLeft, 0, projectionsLeft);
  expressions::Expression *lhs =
      new expressions::RecordProjection(intType, lhsArg, *selectProjLeft1);
  expressions::Expression *rhs = new expressions::IntConstant(100000000);
  expressions::Expression *predicate = new expressions::LtExpression(lhs, rhs);
  ...
  for (int i = 1; i <= 30; i++) {
    ...
    sstream << "field" << fieldCount;
    RecordAttribute *field_i = new RecordAttribute(
        fieldCount, filenamePrefixRight, sstream.str().c_str(), intType);
  ...
  BinaryColPlugin *pgColumnarRight = new BinaryColPlugin(
      &ctx, filenamePrefixRight, recIntsRight, whichFieldsRight);
   ...
   * JOIN
   */
  expressions::Expression *leftJoinArg =
      new expressions::InputArgument(intType, 0, projectionsLeft);
  expressions::Expression *left =
      new expressions::RecordProjection(intType, leftJoinArg, *toProjectLeft);
  expressions::Expression *rightJoinArg =
      new expressions::InputArgument(intType, 1, projectionsRight);
  expressions::Expression *right =
      new expressions::RecordProjection(intType, rightJoinArg, *toProjectRight);
  expressions::BinaryExpression *joinPred =
      new expressions::EqExpression(left, right);
  vector<materialization_mode> outputModes;
  outputModes.insert(outputModes.begin(), EAGER);
  ...
  /* XXX Updated Materializer requires 'expressions to be cached'!!!*/
  RecordAttribute projTupleR =
      RecordAttribute(filenamePrefixRight, activeLoop, int64Type);
  expressions::Expression *exprRightOID =
      new expressions::RecordProjection(intType, rightJoinArg, projTupleR);
  ...
  Materializer *matRight = new Materializer(
      whichFieldsRight, whichExpressionsRight, whichOIDs, outputModes2);

  char joinLabel[] = "join1";
  RadixJoin join = RadixJoin(*joinPred, &sel, &scanRight, &ctx, joinLabel,
                             *matLeft, *matRight);
  sel.setParent(&join);
  ...
  expressions::RecordProjection *outputExpr = new expressions::RecordProjection(
      intType, rightJoinArg, *selectProjRight1);
  expressions::Expression *val_true = new expressions::BoolConstant(1);
  expressions::Expression *reducePredicate =
      new expressions::EqExpression(val_true, val_true);
  ...
  //    expressions::Expression* outputExpr = new expressions::IntConstant(1);
  //    expressions::Expression* val_true = new expressions::BoolConstant(1);
  //    expressions::Expression* reducePredicate = new
...
void columnarCachedJoin1() {
  ...
  //    string filenamePrefixRight =
  //    string("inputs/synthetic/100-30cols-fixed");
  /**
   * SCAN1
   */
  ...
  /* XXX Updated Materializer requires 'expressions to be cached'!!!*/
  RecordAttribute projTupleR = RecordAttribute(filenamePrefixRight, activeLoop,
                                               pgColumnarRight->getOIDType());
  expressions::Expression *exprRightOID = new expressions::RecordProjection(
