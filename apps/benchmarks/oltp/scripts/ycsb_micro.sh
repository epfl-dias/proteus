...
expr_dir="/scratch/raza/dag-expr/newrun"
...
do
			...
			do
				...
				echo "#######################################################"
				echo "#######################################################"
      #//--num-workers=36 --ycsb-zipf-theta=0.5 --benchmark=0 --runtime=30 --delta-size=6 --ycsb-write-ratio=0.75 --ycsb-num-cols=64 --ycsb-num-col-upd=4 --ycsb-num-col-read=4 --ycsb-num-col-read-offset=2
