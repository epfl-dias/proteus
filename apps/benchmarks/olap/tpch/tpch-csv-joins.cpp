...
void tpchJoin1a(map<string, dataset> datasetCatalog, int predicate) {
  ...
  pm::CSVPlugin *pgOrders =
      new pm::CSVPlugin(&ctx, ordersName, recOrders, orderProjections,
  ...
  pm::CSVPlugin *pgLineitem =
      new pm::CSVPlugin(&ctx, lineitemName, recLineitem, lineitemProjections,
                        delimInner, lineHint, policy);
