...
#ifndef HARMONIA_QUERIES_CH_Q2_HPP_
#define HARMONIA_QUERIES_CH_Q2_HPP_
...
PreparedStatement Q<2>::cpar(DegreeOfParallelism dop, Tp aff_parallel,
                             Tr aff_reduce, DeviceType dev) {
  return Q_2_cpar(dop, aff_parallel, aff_reduce, dev, scan<Tplugin>);
}

#endif /* HARMONIA_QUERIES_CH_Q2_HPP_ */
