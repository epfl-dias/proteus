...
TEST(Sailors, Select) {
  ...
  expressions::Expression *lhsArg =
      new expressions::InputArgument(new FloatType(), 0, projections);
  expressions::Expression *lhs =
      new expressions::RecordProjection(new FloatType(), lhsArg, *age);
...
TEST(Sailors, JoinLeft3) {
  ...
  expressions::Expression *rightArg2 =
      new expressions::InputArgument(intType, 1, projectionsBoats);
  expressions::Expression *right2 =
...
TEST(Sailors, JoinRight3) {
  ...
  // JOIN2
  RecordAttribute projTupleReserves =
      RecordAttribute(filename2, activeLoop, pgReserves->getOIDType());
  ...
  expressions::Expression *leftArg2 =
      new expressions::InputArgument(intType, 0, projectionsReserves);
  expressions::Expression *left2 =
      new expressions::RecordProjection(intType, leftArg2, *bidReserves);

  RecordAttribute projTupleBoats =
      RecordAttribute(filenameBoats, activeLoop, pgBoats->getOIDType());
  list<RecordAttribute> projectionsBoats = list<RecordAttribute>();
  ...
  // JOIN
  RecordAttribute projTupleSailors =
      RecordAttribute(filename, activeLoop, pgSailors->getOIDType());
  ...
  expressions::Expression *leftArg =
      new expressions::InputArgument(intType, 0, projectionsSailors);
  expressions::Expression *left =
      new expressions::RecordProjection(intType, leftArg, *sid);

  // For 100% correctness, I should have a new projections list, and not just
  // the ones from reserves
  expressions::Expression *rightArg =
      new expressions::InputArgument(intType, 1, projectionsReserves);
  expressions::Expression *right =
      new expressions::RecordProjection(intType, rightArg, *sidReserves);
  expressions::BinaryExpression *joinPred =
      new expressions::EqExpression(left, right);
