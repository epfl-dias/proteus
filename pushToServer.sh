...
scp -r operators  karpathi@diascld31.epfl.ch:/cloud_store/manosk/vida-engine/sources/raw-jit-executor/
...
scp -r tests  karpathi@diascld31.epfl.ch:/cloud_store/manosk/vida-engine/sources/raw-jit-executor/
scp -r CMakeLists.txt  karpathi@diascld31.epfl.ch:/cloud_store/manosk/vida-engine/sources/raw-jit-executor/
