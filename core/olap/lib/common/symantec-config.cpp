...
#include "olap/common/symantec-config.hpp"
...
void symantecSchema(map<string, dataset> &datasetCatalog) {
  ...
  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spams56m.json");
  //    symantec.linehint = 55833807;

  string path =
      string("/cloud_store/manosk/data/vida-engine/symantec/spams1m.json");
  symantec.linehint = 999582;

  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spams10m.json");
  //    symantec.linehint = 9995329;

  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spams100k.json");
  //    symantec.linehint = 99967;

  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spams_head.json");
  //    symantec.linehint = 100000;
#endif
  symantec.path = path;
  ...
  RecordAttribute *attach = new RecordAttribute(3, path, "attach", attachList);
  attsSymantec.push_back(attach);
  /* "body_txt_a" : "blablabla" */
  RecordAttribute *body_txt_a =
      new RecordAttribute(4, path, "body_txt_a", stringType);
  ...
  RecordAttribute *charset =
      new RecordAttribute(6, path, "charset", stringType);
  attsSymantec.push_back(charset);
  /* "city" : "Ryazan" */
  RecordAttribute *city = new RecordAttribute(7, path, "city", stringType);
  attsSymantec.push_back(city);
  /* "classA" : "83" */
  RecordAttribute *classA = new RecordAttribute(8, path, "classA", stringType);
  attsSymantec.push_back(classA);
  /* "classB" : "83.149" */
  RecordAttribute *classB = new RecordAttribute(9, path, "classB", stringType);
  attsSymantec.push_back(classB);
  /* "classC" : "83.149" */
  RecordAttribute *classC = new RecordAttribute(10, path, "classC", stringType);
  attsSymantec.push_back(classC);
  /* "content_type" : [ "text/html", "text/plain" ] */
  ListType *contentList = new ListType(*stringType);
  RecordAttribute *content_type =
      new RecordAttribute(11, path, "content_type", contentList);
  attsSymantec.push_back(content_type);
  /* "country" : "Russian Federation" */
  RecordAttribute *country =
      new RecordAttribute(12, path, "country", stringType);
  attsSymantec.push_back(country);
  /* "country_code" : "RU" */
  RecordAttribute *country_code =
      new RecordAttribute(13, path, "country_code", stringType);
  ...
  RecordAttribute *from_domain =
      new RecordAttribute(17, path, "from_domain", stringType);
  ...
  RecordAttribute *rcpt_domain =
      new RecordAttribute(22, path, "rcpt_domain", stringType);
  ...
  RecordAttribute *subject =
      new RecordAttribute(24, path, "subject", stringType);
  ...
  RecordAttribute *domain =
      new RecordAttribute(26, path, "uriDomain", domainList);
  attsSymantec.push_back(domain);
  /* "uri_tld" : [ ".com" ] */
  ListType *tldList = new ListType(*stringType);
  RecordAttribute *uri_tld = new RecordAttribute(27, path, "uri_tld", tldList);
  attsSymantec.push_back(uri_tld);
  /* "x_p0f_detail" : "XP/2000" */
  RecordAttribute *x_p0f_detail =
      new RecordAttribute(28, path, "x_p0f_detail", stringType);
  attsSymantec.push_back(x_p0f_detail);
  /* "x_p0f_genre" : "Windows" */
  RecordAttribute *x_p0f_genre =
      new RecordAttribute(29, path, "x_p0f_genre", stringType);
  attsSymantec.push_back(x_p0f_genre);

  /* "x_p0f_signature" : "64380:116:1:48:M1460,N,N,S:." */
  RecordAttribute *x_p0f_signature =
      new RecordAttribute(29, path, "x_p0f_signature", stringType);
...
void symantecCoreSchema(map<string, dataset> &datasetCatalog) {
...
#ifdef SYMANTEC_SERVER
  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spamsCoreID28m.json");
  //    symantec.linehint = 28000000;

  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spamsCoreID1m.json");
  //    symantec.linehint = 1000000;
  ...
  string path = string(
      "/cloud_store/manosk/data/vida-engine/symantec/spamsCoreID28m.json");
  symantec.linehint = 27991116;

  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spamsCoreID100.json");
  //    symantec.linehint = 100;
#endif
  symantec.path = path;
  ...
  /* "attach" : [ "whigmaleerie.jpg" ] (but tends to be empty) */
  ListType *attachList = new ListType(*stringType);
  RecordAttribute *attach =
      new RecordAttribute(attrCnt, path, "attach", attachList);
  attsSymantec.push_back(attach);
  attrCnt++;
  /* "body_txt_a" : "blablabla" */
  RecordAttribute *body_txt_a =
      new RecordAttribute(attrCnt, path, "body_txt_a", stringType);
  attsSymantec.push_back(body_txt_a);
  attrCnt++;
  /* "charset" : "windows-1252" */
  RecordAttribute *charset =
      new RecordAttribute(attrCnt, path, "charset", stringType);
  attsSymantec.push_back(charset);
  attrCnt++;
  /* "city" : "Ryazan" */
  RecordAttribute *city =
      new RecordAttribute(attrCnt, path, "city", stringType);
  attsSymantec.push_back(city);
  attrCnt++;
  /* "content_type" : [ "text/html", "text/plain" ] */
  ListType *contentList = new ListType(*stringType);
  RecordAttribute *content_type =
      new RecordAttribute(attrCnt, path, "content_type", contentList);
  attsSymantec.push_back(content_type);
  attrCnt++;
  /* "country_code" : "RU" */
  RecordAttribute *country_code =
      new RecordAttribute(attrCnt, path, "country_code", stringType);
  attsSymantec.push_back(country_code);
  attrCnt++;
  /* "cte" : "unknown" */
  ...
  /* "from_domain" : "domain733674.com" */
  RecordAttribute *from_domain =
      new RecordAttribute(attrCnt, path, "from_domain", stringType);
  attsSymantec.push_back(from_domain);
  attrCnt++;
  /* "host" : "airtelbroadband.in (but tends to be empty) */
  RecordAttribute *host =
      new RecordAttribute(attrCnt, path, "host", stringType);
  attsSymantec.push_back(host);
  attrCnt++;
  /* "lang" : "english" */
  RecordAttribute *lang =
      new RecordAttribute(attrCnt, path, "lang", stringType);
  attsSymantec.push_back(lang);
  attrCnt++;
  /* "lat" : 54.6197 */
  ...
  attrCnt++;
  /* "long" : 39.74 */
  RecordAttribute *long_ =
      new RecordAttribute(attrCnt, path, "long", floatType);
  attsSymantec.push_back(long_);
  attrCnt++;
  /* "rcpt_domain" : "domain555065.com" */
  RecordAttribute *rcpt_domain =
      new RecordAttribute(attrCnt, path, "rcpt_domain", stringType);
  attsSymantec.push_back(rcpt_domain);
  attrCnt++;
  /* "size" : 3712 */
  ...
  /* "subject" : "LinkedIn Messages, 9/30/2010" */
  RecordAttribute *subject =
      new RecordAttribute(attrCnt, path, "subject", stringType);
  attsSymantec.push_back(subject);
  attrCnt++;
  /* "uri" : [ "http://hetfonteintje.com/1.html" ] */
  ListType *uriList = new ListType(*stringType);
  ...
  ListType *domainList = new ListType(*stringType);
  RecordAttribute *domain =
      new RecordAttribute(attrCnt, path, "uri_domain", domainList);
  attsSymantec.push_back(domain);
  /* "uri_tld" : [ ".com" ] */
  ListType *tldList = new ListType(*stringType);
  RecordAttribute *uri_tld =
      new RecordAttribute(attrCnt, path, "uri_tld", tldList);
  attsSymantec.push_back(uri_tld);
  attrCnt++;
  /* "x_p0f_detail" : "XP/2000" */
  RecordAttribute *x_p0f_detail =
      new RecordAttribute(attrCnt, path, "x_p0f_detail", stringType);
  attsSymantec.push_back(x_p0f_detail);
  attrCnt++;
  /* "x_p0f_genre" : "Windows" */
  RecordAttribute *x_p0f_genre =
      new RecordAttribute(attrCnt, path, "x_p0f_genre", stringType);
  attsSymantec.push_back(x_p0f_genre);
  attrCnt++;

  /* "x_p0f_signature" : "64380:116:1:48:M1460,N,N,S:." */
  RecordAttribute *x_p0f_signature =
      new RecordAttribute(attrCnt, path, "x_p0f_signature", stringType);
  attsSymantec.push_back(x_p0f_signature);
  attrCnt++;
...
void symantecCoreIDDatesSchema(map<string, dataset> &datasetCatalog) {
  ...
  //    symantec.linehint = 100;
  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spamsCoreIDDates28m-edit.json");
  string path = string(
      "/cloud_store/manosk/data/vida-engine/symantec/"
      "spamsCoreIDDates28m-bigids.json");
  symantec.linehint = 27991116;
...
void symantecBinSchema(map<string, dataset> &datasetCatalog) {
...
#ifdef SYMANTEC_SERVER
  string path =
      string("/cloud_store/manosk/data/vida-engine/symantec/col/symantec");
  symantecBin.linehint = 500000000;
#endif
  ...
  attrCnt++;
  /* dataset */
  RecordAttribute *dataset =
      new RecordAttribute(attrCnt, path, "dataset", stringType);
  attsSymantec.push_back(dataset);
  attrCnt++;
  /* analysis */
  RecordAttribute *analysis =
      new RecordAttribute(attrCnt, path, "analysis", stringType);
  attsSymantec.push_back(analysis);
  attrCnt++;
  /* slice_id */
  RecordAttribute *slice_id =
      new RecordAttribute(attrCnt, path, "slice_id", intType);
  attsSymantec.push_back(slice_id);
  attrCnt++;
  /* cluster */
  RecordAttribute *cluster =
      new RecordAttribute(attrCnt, path, "cluster", intType);
  ...
  RecordAttribute *neighbors =
      new RecordAttribute(attrCnt, path, "neighbors", intType);
  ...
  RecordAttribute *p_event =
      new RecordAttribute(attrCnt, path, "p_event", floatType);
  attsSymantec.push_back(p_event);
  attrCnt++;
  /* value */
  RecordAttribute *value =
      new RecordAttribute(attrCnt, path, "value", floatType);
  attsSymantec.push_back(value);
  attrCnt++;
  /* pattern */
  RecordAttribute *pattern =
      new RecordAttribute(attrCnt, path, "pattern", stringType);
...
void symantecCSVSchema(map<string, dataset> &datasetCatalog) {
...
#ifdef SYMANTEC_LOCAL
  //    string path =
  //    string("inputs/json/spam/spamsClasses1000-unordered-nocomma.csv");
...
#ifdef SYMANTEC_SERVER
  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spamsClasses1000-unordered-nocomma.csv");
  //    symantecCSV.linehint = 1000;
  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spamsClasses1-unordered-nocomma.csv");
  //    symantecCSV.linehint = 3;
  string path = string(
      "/cloud_store/manosk/data/vida-engine/symantec/"
      "spamsClasses400m-unordered-nocomma.csv");
  symantecCSV.linehint = 400000000;
  //    string path =
  //    string("/cloud_store/manosk/data/vida-engine/symantec/spamsClasses1000-unordered.csv");
  //    symantecCSV.linehint = 1000;
#endif
  ...
  RecordAttribute *classa =
      new RecordAttribute(attrCnt, path, "classa", intType);
  attsSymantec.push_back(classa);
  attrCnt++;
  /* classb */
  RecordAttribute *classb =
      new RecordAttribute(attrCnt, path, "classb", floatType);
  attsSymantec.push_back(classb);
  attrCnt++;
  /* city */
  RecordAttribute *city =
  ...
  /* country */
  RecordAttribute *country =
      new RecordAttribute(attrCnt, path, "country", stringType);
  attsSymantec.push_back(country);
  attrCnt++;
  /* country_code */
  RecordAttribute *country_code =
