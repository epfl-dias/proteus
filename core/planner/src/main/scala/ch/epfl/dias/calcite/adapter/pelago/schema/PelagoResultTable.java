...
import ch.epfl.dias.calcite.adapter.pelago.executor.PelagoEnumerator;
import ch.epfl.dias.calcite.adapter.pelago.rel.PelagoResultScan;
    ...
    public Enumerable<Object[]> scan(DataContext root) {
        ...
        return new AbstractEnumerable<Object[]>() {
            public Enumerator<Object[]> enumerator() {
                return new PelagoEnumerator<>(source, cancelFlag, rowType.getFieldList(), fields, root.getTypeFactory(), mock);
