...
void symantecBinCSVJSON1Debug1(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predicateCSV;
  {
    ...
    expressions::Expression *predicateNum =
        new expressions::AndExpression(predicateAnd1, predicate3);
    ...
    predicateCSV = new expressions::EqExpression(selBot, predExpr4);
...
int main() {
  ...
  cout << "SYMANTEC BIN-CSV-JSON TEST(1)" << endl;
  symantecBinCSVJSON1Debug1(datasetCatalog);
...
void symantecBinCSVJSON0(map<string, dataset> datasetCatalog) {
  ...
  RadixJoin *join = new RadixJoin(*joinPred, selBin, scanCSV, &ctx, joinLabel,
                                  *matLeft, *matRight);
  ...
  //    expressions::Expression* leftArg = new
  //    expressions::InputArgument(&recBin,
  //                0, argProjections);
...
void symantecBinCSVJSON2(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *selCluster = new expressions::RecordProjection(
      cluster->getOriginalType(), arg, *cluster);
  expressions::Expression *predExpr = new expressions::IntConstant(clusterHigh);
  predicateBin = new expressions::LtExpression(selCluster, predExpr);
...
void symantecBinCSVJSON3(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *selCluster = new expressions::RecordProjection(
      cluster->getOriginalType(), arg, *cluster);
  expressions::Expression *predExpr = new expressions::IntConstant(clusterLow);
  predicateBin = new expressions::GtExpression(selCluster, predExpr);
...
void symantecBinCSVJSON6(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predicateCSV;
  {
    ...
    predicateCSV = new expressions::OrExpression(predicate3, predicateOr2);
    selCSV = new Select(predicateCSV, selNum);
    selNum->setParent(selCSV);
  }
...
void symantecBinCSVJSON7(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predExpr1 = new expressions::IntConstant(idHigh);
  predicateBin = new expressions::LtExpression(selID, predExpr1);
  Select *selBin = new Select(predicateBin, scanBin);
  scanBin->setParent(selBin);
  ...
  expressions::Expression *predicateCSV;
  {
    ...
    expressions::Expression *predExpr2 = new expressions::IntConstant(idHigh);
    predicateCSV = new expressions::LtExpression(selID, predExpr2);
  }
...
void symantecBinCSVJSON8(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predicateCSV;
  {
    ...
    expressions::Expression *predExpr2 =
        new expressions::IntConstant(classaLow);
    expressions::Expression *predicate2 =
        new expressions::GtExpression(selClassa, predExpr2);
    ...
    expressions::Expression *predicateAnd =
        new expressions::AndExpression(predicate1, predicate2);
    predicateCSV = new expressions::AndExpression(predicateAnd, predicate3);
  }
  ...
  radix::Nest *nestOp =
      new radix::Nest(&ctx, accs, outputExprs, aggrLabels, predNest, f, f,
...
void symantecBinCSVJSON9(map<string, dataset> datasetCatalog) {
  ...
  expressions::Expression *predicateAnd =
      new expressions::AndExpression(predicate1, predicate2);
  predicateBin = new expressions::AndExpression(predicateAnd, predicate3);
  ...
  expressions::Expression *predicateCSV;
  {
    ...
    predicateCSV = new expressions::AndExpression(predicateAnd1, predicateAnd2);
  }
