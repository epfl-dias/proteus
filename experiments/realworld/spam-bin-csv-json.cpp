...
void symantecBinCSVJSON2Debug1(map<string, dataset> datasetCatalog) {
	...
	expressions::Expression* predExpr = new expressions::FloatConstant(
			p_eventHigh);
	predicateBin = new expressions::LtExpression(new BoolType(), selEvent, predExpr);
...
//	expressions::Expression* predicateA = new expressions::EqExpression(new BoolType(), selID, predExprA);
//	expressions::Expression* predicateB = new expressions::EqExpression(new BoolType(), selID, predExprB);
//	expressions::Expression* predicateC = new expressions::EqExpression(new BoolType(), selID, predExprC);
//	expressions::Expression* predicateD = new expressions::EqExpression(new BoolType(), selID, predExprD);
//
//	expressions::Expression* predicateOr1 = new expressions::OrExpression(new BoolType(), predicateA,predicateB);
//	expressions::Expression* predicateOr2 = new expressions::OrExpression(new BoolType(), predicateC,predicateD);
//	predicateJSON = new expressions::OrExpression(new BoolType(), predicateOr1,predicateOr2);
...
void symantecBinCSVJSON3(map<string, dataset> datasetCatalog) {
	...
	expressions::Expression* predExpr = new expressions::FloatConstant(
			p_eventLow);
	predicateBin = new expressions::GtExpression(new BoolType(), selEvent, predExpr);
