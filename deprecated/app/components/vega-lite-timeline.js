...
import { default as vl } from 'npm:vega-lite/build/vega-lite.js';
...
export default Component.extend({
    ...
    spec: computed(function() {
        ...
        let mapHeight = 0;
        this.set('height', this.$(document).height() - top - mapHeight - 20);
        this.set('width' , this.$(document).width ()                   - 256);

        return vl.compile({
            "$schema": "https://vega.github.io/schema/vega-lite/v2.json", //https://vega.github.io/schema/vega/v4.json",
            "padding": 5,
            "autosize": {
                "type": "fit",
                "contains": "padding"
            ...
            "vconcat": [
                {
            "height": this.get('height')*0.8,
            "width": this.get('width'),
                    "selection": {
                        "xbrush": {
                            "type": "interval", "encodings": ["x", "x2"], "bind": "scales"
                        }
                    },
                    "mark": "rect",
                    "encoding": {
                        "x" : {"type": "quantitative", "field": "start"},
                        "x2": {"type": "quantitative", "field": "end"},
                        "y": {"type": "nominal", "field": "label", "scale": {"rangeStep": null}},
                        // "color": {"type": "nominal", "field": "label"}
                        "color": {
                          "condition": {
                            "selection": "xbrush",
                            "type": "nominal", "field": "className"
                          },
                          "value": "grey"
                        }
    ...
    //     // console.log(select("#container").node().getBoundingClientRect().top);
        ...
        //     let top = this_.$()[0].getBoundingClientRect().top;
        ...
        //     console.log(this_.$()[0])
        //     this_.$()[0].height(this_.get('height'));
        //     this_.$()[0].width(this_.get('width'));
        //     console.log(this_.$()[0])
