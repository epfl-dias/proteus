...
//			cout << "Filled STRING: " << start + 1 << " to " << parser->pos << endl;
//#ifdef JSMN_PARENT_LINKS
//			token->parent = parser->toksuper;
//#endif
//			return JSMN_OK;
...
//				{
//					printf(
//							"Invalid character at position %u - unexpected symbol\n",
//							parser->pos);
//				}
//#endif
//				return JSMN_ERROR_INVAL;
...
//	//cout << "How many tokens actually needed?? " << count << endl;
//	return JSMN_OK;
//}
//
///**
