...
#define O_ORDERKEY_MIN 1
#define O_CUSTKEY_MIN 1
#define O_TOTALPRICE_MIN 811.73
#define O_SHIPPRIORITY_MIN 0

#define O_ORDERKEY_MAX 600000000
#define O_CUSTKEY_MAX 14999999
#define O_TOTALPRICE_MAX 591036.15
#define O_SHIPPRIORITY_MAX 0
...
#define L_LINENUMBER_MIN 1
#define L_QUANTITY_MIN 1.0
#define L_EXTENDEDPRICE_MIN 900.05
#define L_DISCOUNT_MIN 0.00
#define L_TAX_MIN 0.00

#define L_ORDERKEY_MAX 600000000
#define L_PARTKEY_MAX 20000000
#define L_SUPPKEY_MAX 1000000
#define L_LINENUMBER_MAX 7
#define L_QUANTITY_MAX 50.00
#define L_EXTENDEDPRICE_MAX 104948.5
#define L_DISCOUNT_MAX 0.10
#define L_TAX_MAX 0.08
#endif
...
#ifdef TPCH_SF10
  /* Lineitem */
  string lineitemPath = string(
      "/cloud_store/manosk/data/vida-engine/tpch_2_17_0/sf10/lineitem.csv");
  lineitem.linehint = 59986052;
  /* Orders */
  string ordersPath = string(
      "/cloud_store/manosk/data/vida-engine/tpch_2_17_0/sf10/orders.csv");
...
void tpchSchemaJSON(map<string, dataset> &datasetCatalog) {
  ...
  string ordersLineitemsPath =
      string("inputs/tpch/json/ordersLineitemsArray20.json");
  //    string ordersLineitemsPath = string(
  ...
  string lineitemPath = string(
      ...
      "tpch_2_17_0/sf10/lineitemFlatSF10.json");
  lineitem.linehint = 59986052;
  /* Orders */
  string ordersPath = string(
   ...
   * i.e., pre-materialized join */
  string ordersLineitemsPath = string(
      "/cloud_store/manosk/data/vida-engine/tpch_2_17_0/sf10/"
      "ordersLineitemsArray.json");
  ...
  RecordAttribute *tax = new RecordAttribute(8, lineitemPath, "tax", floatType);
  ...
  {
    RecordAttribute *partkey =
        new RecordAttribute(1, ordersLineitemsPath, "partkey", intType);
    attsLineitemNested.push_back(partkey);
    RecordAttribute *suppkey =
        new RecordAttribute(2, ordersLineitemsPath, "suppkey", intType);
    attsLineitemNested.push_back(suppkey);
    RecordAttribute *linenumber =
        new RecordAttribute(3, ordersLineitemsPath, "linenumber", intType);
    attsLineitemNested.push_back(linenumber);
    RecordAttribute *quantity =
        new RecordAttribute(4, ordersLineitemsPath, "quantity", floatType);
    attsLineitemNested.push_back(quantity);
    RecordAttribute *extendedprice =
        new RecordAttribute(5, ordersLineitemsPath, "extendedprice", floatType);
    attsLineitemNested.push_back(extendedprice);
    RecordAttribute *discount =
        new RecordAttribute(6, ordersLineitemsPath, "discount", floatType);
    attsLineitemNested.push_back(discount);
    RecordAttribute *tax =
        new RecordAttribute(7, ordersLineitemsPath, "tax", floatType);
    attsLineitemNested.push_back(tax);
    RecordAttribute *returnflag =
        new RecordAttribute(8, ordersLineitemsPath, "returnflag", stringType);
    attsLineitemNested.push_back(returnflag);
    RecordAttribute *linestatus =
        new RecordAttribute(9, ordersLineitemsPath, "linestatus", stringType);
    attsLineitemNested.push_back(linestatus);
    RecordAttribute *shipdate =
        new RecordAttribute(10, ordersLineitemsPath, "shipdate", stringType);
    attsLineitemNested.push_back(shipdate);
    RecordAttribute *commitdate =
        new RecordAttribute(11, ordersLineitemsPath, "commitdate", stringType);
    attsLineitemNested.push_back(commitdate);
    RecordAttribute *receiptdate =
        new RecordAttribute(12, ordersLineitemsPath, "receiptdate", stringType);
    attsLineitemNested.push_back(receiptdate);
    RecordAttribute *shipinstruct = new RecordAttribute(
        13, ordersLineitemsPath, "shipinstruct", stringType);
    attsLineitemNested.push_back(shipinstruct);
    RecordAttribute *shipmode =
        new RecordAttribute(14, ordersLineitemsPath, "shipmode", stringType);
    attsLineitemNested.push_back(shipmode);
    RecordAttribute *l_comment =
        new RecordAttribute(15, ordersLineitemsPath, "comment", stringType);
  ...
  {
    RecordAttribute *o_orderkey =
        new RecordAttribute(1, ordersLineitemsPath, "orderkey", intType);
    attsOrdersLineitems.push_back(o_orderkey);
    RecordAttribute *custkey =
        new RecordAttribute(2, ordersLineitemsPath, "custkey", intType);
    attsOrdersLineitems.push_back(custkey);
    RecordAttribute *orderstatus =
        new RecordAttribute(3, ordersLineitemsPath, "orderstatus", stringType);
    attsOrdersLineitems.push_back(orderstatus);
    RecordAttribute *totalprice =
        new RecordAttribute(4, ordersLineitemsPath, "totalprice", floatType);
    attsOrdersLineitems.push_back(totalprice);
    RecordAttribute *orderdate =
        new RecordAttribute(5, ordersLineitemsPath, "orderdate", stringType);
    attsOrdersLineitems.push_back(orderdate);
    RecordAttribute *orderpriority = new RecordAttribute(
        6, ordersLineitemsPath, "orderpriority", stringType);
    attsOrdersLineitems.push_back(orderpriority);
    RecordAttribute *clerk =
        new RecordAttribute(7, ordersLineitemsPath, "clerk", stringType);
    attsOrdersLineitems.push_back(clerk);
    RecordAttribute *shippriority =
        new RecordAttribute(8, ordersLineitemsPath, "shippriority", intType);
    attsOrdersLineitems.push_back(shippriority);
    RecordAttribute *o_comment =
        new RecordAttribute(9, ordersLineitemsPath, "comment", stringType);
    attsOrdersLineitems.push_back(o_comment);
    RecordAttribute *lineitems = new RecordAttribute(
        10, ordersLineitemsPath, "lineitems", lineitemNestedRec);
...
void tpchSchemaBin(map<string, dataset> &datasetCatalog) {
  ...
  /* Lineitem */
  string lineitemPath = string(
      "/cloud_store/manosk/data/vida-engine/tpch_2_17_0/sf10/col/lineitem");
  lineitem.linehint = 59986052;
  /* Orders */
  string ordersPath = string(
      "/cloud_store/manosk/data/vida-engine/tpch_2_17_0/sf10/col/orders");
  orders.linehint = 15000000;
#endif
#ifdef TPCH_SF100
  /* Lineitem */
  string lineitemPath = string(
      "/cloud_store/manosk/data/vida-engine/tpch_2_17_0/sf100/col/lineitem");
  lineitem.linehint = 600037902;
  /* Orders */
  string ordersPath = string(
      "/cloud_store/manosk/data/vida-engine/tpch_2_17_0/sf100/col/orders");
