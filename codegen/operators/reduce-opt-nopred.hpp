...
#ifndef REDUCE_OPT_NOPRED_HPP_
#define REDUCE_OPT_NOPRED_HPP_
...
public:
	ReduceNoPred(vector<Monoid> accs, vector<expressions::Expression*> outputExprs,
			RawOperator* const child,
			RawContext* context);
	virtual ~ReduceNoPred() {
