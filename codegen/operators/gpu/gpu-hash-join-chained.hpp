...
class GpuHashJoinChained : public BinaryRawOperator {
 public:
  GpuHashJoinChained(const std::vector<GpuMatExpr> &build_mat_exprs,
  ...
  virtual ~GpuHashJoinChained() {
    LOG(INFO) << "Collapsing GpuHashJoinChained operator";
  }
