...
void NullFilter::consume(RawContext* const context, const OperatorState& childState) {
	generate(context, childState);
}

void NullFilter::generate(RawContext* const context, const OperatorState& childState) const
{
