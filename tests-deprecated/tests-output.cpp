...
TEST(Output, ReduceBagRecord) {
  ...
  expressions::RecordProjection *projID =
      new expressions::RecordProjection(intType, arg, *sid);
...
TEST(Output, NestBagTPCH) {
  ...
  expressions::Expression *nestResultArg =
      new expressions::InputArgument(&newRecType, 0, newArgTypes);
  expressions::RecordProjection *projCnt =
      new expressions::RecordProjection(intType, nestResultArg, *cnt);
  expressions::RecordProjection *projMax =
      new expressions::RecordProjection(floatType, nestResultArg, *max_qty);
...
TEST(Output, JoinLeft3) {
  ...
  int linehint = 10;
  int policy = 2;
  pm::CSVPlugin *pgSailors = new pm::CSVPlugin(
      &ctx, filename, rec1, whichFields, ';', linehint, policy, false);
  ...
  RecordAttribute *sidReserves =
      new RecordAttribute(1, filename2, string("sid"), intType);
  RecordAttribute *bidReserves =
      new RecordAttribute(2, filename2, string("bid"), intType);
  RecordAttribute *day =
      new RecordAttribute(3, filename2, string("day"), stringType);
  ...
  linehint = 10;
  policy = 2;
  pm::CSVPlugin *pgReserves = new pm::CSVPlugin(
      &ctx, filename2, rec2, whichFields2, ';', linehint, policy, false);
  ...
  RecordAttribute projTupleL =
      RecordAttribute(filename, activeLoop, pgSailors->getOIDType());
  ...
  expressions::Expression *leftOidProj =
      new expressions::RecordProjection(intType, leftArg, projTupleL);
  expressions::Expression *leftSidProj =
  ...
  RecordAttribute projTupleR =
      RecordAttribute(filename2, activeLoop, pgReserves->getOIDType());
  ...
  expressions::Expression *rightSidProj =
  ...
  expressions::BinaryExpression *joinPred =
      new expressions::EqExpression(leftSidProj, rightSidProj);
  ...
  pm::CSVPlugin *pgBoats =
      new pm::CSVPlugin(&ctx, filenameBoats, recBoats, whichFieldsBoats, ';',
                        linehint, policy, false);
  ...
  expressions::Expression *oidBoatsProj = new expressions::RecordProjection(
      pgBoats->getOIDType(), rightArg2, projTupleBoat);
  ...
  expressions::BinaryExpression *joinPred2 =
      new expressions::EqExpression(left2, bidBoatsProj);
