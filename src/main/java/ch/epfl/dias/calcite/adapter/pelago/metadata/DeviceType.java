...
//  MetadataDef<BuiltInMetadata.DeviceType> DEF = MetadataDef.of(BuiltInMetadata.DeviceType.class,
//      BuiltInMetadata.DeviceType.Handler.class, BuiltInMethod.DEVICETYPE.method);
//
//  /** Determines how the rows are distributed. */
//  RelDeviceType deviceType();
//
//  /** Handler API. */
//  interface Handler extends MetadataHandler<BuiltInMetadata.DeviceType> {
