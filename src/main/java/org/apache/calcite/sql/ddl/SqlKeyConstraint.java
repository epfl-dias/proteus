...
public class SqlKeyConstraint extends SqlCall {
  ...
  public static org.apache.calcite.sql.ddl.SqlKeyConstraint unique(SqlParserPos pos, SqlIdentifier name,
                                                                   SqlNodeList columnList) {
    return new org.apache.calcite.sql.ddl.SqlKeyConstraint(pos, name, columnList);
  }

  /** Creates a PRIMARY KEY constraint. */
  public static org.apache.calcite.sql.ddl.SqlKeyConstraint primary(SqlParserPos pos, SqlIdentifier name,
                                                                    SqlNodeList columnList) {
    return new org.apache.calcite.sql.ddl.SqlKeyConstraint(pos, name, columnList) {
